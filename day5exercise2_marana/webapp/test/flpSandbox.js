		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zroutingday5exercise2marana-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zroutingday5exercise2marana-display": {
								"semanticObject": "zroutingday5exercise2marana",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zrouting.day5exercise2marana",
									"url": sap.ui.require.toUrl("zrouting/day5exercise2marana")
								}
							}
						}
					}
